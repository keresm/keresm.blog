!(function (e, t) {
      ...
      for (
        var o = [],
          ...
          s = w[t].events.map(function (t, r) {
            return {
              event: t,
              func: new Promise(function (n, i) {
                (o[r] = { event: t, func: _(e, t.name, a.eventId, n) }),
        ...
        r.apply(e, c),
          ...
          "fitScreenCoordinates" === t &&
            ...
            (arguments.length <= 3 ? void 0 : arguments[3]) &&
              "object" ===
                i.default(arguments.length <= 3 ? void 0 : arguments[3]) &&
              (l = b(b({}, l), arguments.length <= 3 ? void 0 : arguments[3]))),
          (p = s.map(function (t) {
            var r = t.event,
              n = t.func;
  ...
  var D = {
    ...
    props: (function (e) {
      ...
      return e;
    })({ mapboxGl: { type: Object, default: null } }, p),
    provide: function () {
      var e = this;
      return {
        get mapbox() {
  ...
  var T = {
      methods: {
        $_emitSelfEvent: function (e) {
          var t =
            arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {};
          this.$_emitMapEvent(e, B({ control: this.control }, t));
        },
    ...
    R = {
      ...
      created: function () {
        ...
        (this.control = new e(this.$props)),
          this.$_addControl(),
          this.$_bindSelfEvents(Object.keys(Z), this.control);
      },
      methods: {
        trigger: function () {
  ...
  var G = { drag: "drag", dragstart: "dragstart", dragend: "dragend" },
  ...
  var oe = {
    ...
    computed: {
      ...
      getRenderedFeatures: function () {
        ...
        return function (t, r) {
          return e.map
            ? e.map.queryRenderedFeatures(t, { layers: [e.layerId], filter: r })
            : null;
        };
      },
    ...
    methods: {
      $_deferredMount: function () {
        if (
          ...
          var e = ne({ type: "geojson" }, this.source);
          try {
      ...
      $_addLayer: function () {
        ...
        var t = ne({ id: this.layerId, source: this.sourceId }, this.layer);
  ...
  var fe = c,
    ...
    ge = z,
    be = te,
    ve = { withEvents: c, withSelfEvents: T, asControl: z, asLayer: te },
    Oe = D,
    je = F,
    $e = R,
    Pe = A,
    ...
    Ie = {
      ...
      methods: {
        $_deferredMount: function () {
          var e = ae({ type: "image" }, this.source);
          ...
          this.$_addLayer(), this.$_bindLayerEvents(K), (this.initial = !1);
        },
        $_addLayer: function () {
          var e = this.map.getLayer(this.layerId);
          if (e) {
    ...
    Ee = {
      ...
      methods: {
        $_deferredMount: function () {
          var e = ce({ type: "canvas" }, this.source);
          this.map.on("dataloading", this.$_watchSourceLoading);
          try {
            this.map.addSource(this.sourceId, e);
          } catch (t) {
    ...
    Le = {
      ...
      methods: {
        $_deferredMount: function () {
          var e = pe({ type: "video" }, this.source);
          this.map.on("dataloading", this.$_watchSourceLoading);
          try {
            this.map.addSource(this.sourceId, e);
          } catch (t) {
    ...
    xe = {
      ...
      methods: {
        $_deferredMount: function () {
          var e = de({ type: "vector" }, this.source);
          this.map.on("dataloading", this.$_watchSourceLoading);
          try {
            this.map.addSource(this.sourceId, e);
          } catch (t) {
        ...
        $_addLayer: function () {
          ...
          var t = de({ id: this.layerId, source: this.sourceId }, this.layer);
          this.map.addLayer(t, this.before),
            this.$_emitEvent("added", { layerId: this.layerId });
        },
        setFeatureState: function (e, t) {
    ...
    ke = {
      ...
      methods: {
        $_deferredMount: function () {
          var e = me({ type: "raster" }, this.source);
          this.map.on("dataloading", this.$_watchSourceLoading);
          try {
            this.map.addSource(this.sourceId, e);
          } catch (t) {
    ...
    De = J;
  (e.$helpers = ve),
    (e.MglAttributionControl = we),
    (e.MglCanvasLayer = Ee),
    (e.MglFullscreenControl = Pe),
    (e.MglGeojsonLayer = _e),
    (e.MglGeolocateControl = $e),
    (e.MglImageLayer = Ie),
    (e.MglMap = Oe),
    (e.MglMarker = Me),
    (e.MglNavigationControl = je),
    (e.MglPopup = De),
    (e.MglRasterLayer = ke),
    (e.MglScaleControl = Se),
    (e.MglVectorLayer = xe),
    (e.MglVideoLayer = Le),
    (e.asControl = ge),
    (e.asLayer = be),
